    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white p-4 rounded-lg shadow">
        ...
        <div className="border-b pb-4">
          ...
          <input type="text" placeholder="Nom et prénom" value={nom} onChange={(e) => setNom(e.target.value)} required className="w-full p-2 mb-2 border rounded" />
          <input type="tel" placeholder="Téléphone / WhatsApp" value={telephone} onChange={(e) => setTelephone(e.target.value)} className="w-full p-2 mb-2 border rounded" />
        ...
        <div className="border-b pb-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <input type="text" name="longueur_epaule" placeholder="Longueur épaule" value={mes.longueur_epaule} onChange={handleMesChange} className="p-2 border rounded" />
